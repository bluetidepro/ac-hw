  ...
  render() {
    ...
    return (
      <div className="CardBody">
        {!goalReached && <h1>Only four days left to fund this project</h1>}
        {goalReached && (
          <h1>
            We've met our goal of ${FORMAT_CURRENCY(TOTAL_FUND_GOAL)}, but you
            still have four days left to contribute even more!
          </h1>
        )}
        {donors > 0 && (
          <p>
            Join the <strong>{donors}</strong> other{' '}
            {pluralize('donor', donors)} who have already supported this
            project.
          </p>
        )}
        {donors === 0 && (
